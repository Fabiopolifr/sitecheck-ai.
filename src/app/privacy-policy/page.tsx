        ...
        <div className="mt-10 flex flex-col gap-8 text-sm leading-7 text-zinc-700">
          <section>
            ...
            <p className="mt-2">
              ...
              (BA), Italia — P.IVA 09004560729. Per qualsiasi richiesta relativa
              al trattamento dei dati personali puoi scrivere a{" "}
              <a
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              funzionare il servizio, non la privacy policy generale del sito
              freesbe.it.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="mt-2 flex flex-col gap-3">
              <li>
                ...
                rilevati per categoria). Non richiediamo credenziali di accesso
                al sito analizzato.
              </li>
              <li>
                <span className="font-medium text-zinc-900">
                ...
                rispetto all&apos;invio del report, che è un servizio richiesto
                attivamente.
              </li>
              <li>
                <span className="font-medium text-zinc-900">
                ...
                <code>localStorage</code>, non un cookie) per collegare tra loro
                le azioni di una stessa visita (es. analisi avviata → risultati
                visti → report richiesto). Non è collegato a un&apos;identità
                reale a meno che tu non invii volontariamente la tua email.
              </li>
              <li>
                <span className="font-medium text-zinc-900">
                  Dati tecnici di utilizzo.
                </span>{" "}
                Eventi anonimi come visita alla pagina, avvio/completamento di
                un&apos;analisi, invio email, click su un partner affiliato —
                usati solo per statistiche interne aggregate di funzionamento
                del servizio.
              </li>
              <li>
                <span className="font-medium text-zinc-900">Indirizzo IP.</span>{" "}
                Utilizzato tecnicamente e in modo transitorio per limitare il
                numero di richieste automatiche (protezione da abusi), non
                salvato in forma leggibile insieme ai risultati delle analisi.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              GDPR), per il legittimo interesse a garantire sicurezza e corretto
              funzionamento del servizio (art. 6.1.f), e — solo per le
              comunicazioni di marketing — sulla base del consenso esplicito e
              separato che ci fornisci (art. 6.1.a), revocabile in qualsiasi
              momento.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              memorizzazione dei risultati, e — solo se attivi per il tuo invio
              — un provider di intelligenza artificiale per generare il
              riassunto testuale del report, un provider di invio email per
              recapitare il report richiesto, e l&apos;API Google PageSpeed
              Insights per la misurazione delle performance. Nessuno di questi
              fornitori riceve dati per finalità pubblicitarie proprie.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              rispondere a obblighi di legge. Puoi richiedere in qualsiasi
              momento la cancellazione dei tuoi dati (in particolare
              l&apos;indirizzo email fornito) scrivendo a{" "}
              <a
                href="mailto:privacy@freesbe.it"
                className="text-accent hover:underline"
              >
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              cancellazione, limitazione e opposizione al trattamento, oltre al
              diritto alla portabilità dei dati, ai sensi degli artt. 15–22 del
              ...
              e hai diritto di proporre reclamo al Garante per la protezione dei
              dati personali (www.garanteprivacy.it).
            </p>
          </section>

          <section>
            <h2 className="text-base font-semibold text-zinc-900">Cookie</h2>
            <p className="mt-2">
